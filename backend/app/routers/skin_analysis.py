...
async def save_skin_analysis(
    ...
    if db is None:
        ...
        session_data["skin_type"] = analysis.skin_type
        session_data["skin_issues"] = analysis.skin_issues
        session_data["issue_duration"] = analysis.issue_duration
        session_data["severity"] = analysis.severity
        memory_sessions[str(session_id)] = session_data
    else:
        # Find the session
